...
/* harmony import */ var _store_Store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("GEZC");
...
class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_2___default.a {
  constructor(props) {
    super(props);
    this.state = _objectSpread({}, _store_Store__WEBPACK_IMPORTED_MODULE_3__[/* initialState */ "c"]);
    this.dispatch = this.dispatch.bind(this);
  }

  dispatch(action) {
    this.setState(prevState => Object(_store_Store__WEBPACK_IMPORTED_MODULE_3__[/* reducer */ "d"])(prevState, action));
  }
  ...
  render() {
    ...
    return __jsx(_store_Store__WEBPACK_IMPORTED_MODULE_3__[/* StoreProvider */ "a"], {
      value: {
        state: this.state,
